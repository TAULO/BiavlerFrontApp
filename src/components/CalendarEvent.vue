    ...
    <div class="card m-4 p-3">
        ...
        <div class="card-body whitespace-fix">
            ...
            <div class="d-flex justify-content-end" v-if="user.loggedIn">
                <i class="bi bi-arrow-clockwise position-absolute me-4" @click="$emit('openUpdateModal', id)" data-bs-toggle="modal" data-bs-target="#addEventModal"></i>
    ...
    export default {
        ...
        methods: {
                dateConverter(dateString) {
                    ...
                    return minutes !== 0 ? `${danishDay} den ${dayOfMonth} ${danishMonth} ${year} kl. ${hours + 2}:${minutes}` : `${danishDay} den ${dayOfMonth} ${danishMonth} ${year} kl. ${hours}`
                },
            },
        }
</script>
